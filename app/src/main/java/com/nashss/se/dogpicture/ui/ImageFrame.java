...
public class ImageFrame extends JFrame {
    /**
     * Create a new ImageFrame that will display the image specified by the given url
     * NOTE: Internally, this class delegates displaying the image to an ImageComponent
